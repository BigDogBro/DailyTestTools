...
public class HttpRequest {
	...
	//公用方法，根据返回码处理返回值
	public static Map<String, String> getResponse(HttpURLConnection httpURLConnection, BufferedReader in, Map<String, String> result) throws UnsupportedEncodingException, IOException {
		boolean flag = false;
